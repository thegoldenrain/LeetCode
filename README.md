...
|---| ----- | -------- | ---------- |
|1281|[Subtract the Product and Sum of Digits of an Intege](https://leetcode.com/problems/number-of-steps-to-reduce-a-number-to-zero/)|[Python](../Subtract_the_Product_and_Sum_of_Digits_of_an_Integer/Subtract_the_Product_and_Sum_of_Digits_of_an_Integer.py)|Easy|
